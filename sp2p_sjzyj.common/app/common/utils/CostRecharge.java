...
public class CostRecharge {
	...
	public static final String key ="4d246f6e3fc360dadb124fd42e498fee";//申请的接口Appkey
	
	public static final String openId="JH2f99cebab0faf977eadef40efa8c7ae8";//在个人中心查询
	...
	*/
	public static String onlineOrder(String phone,int cardnum,String orderid) throws Exception{
		...
		//Md5Utils工具类
		String sign = Md5Utils.MD5(openId+key+phone+cardnum+orderid);
	...
	* @throws Exception 
	*/
	public static String balanceMoney() throws Exception{
		String timestamp = System.currentTimeMillis()/1000+"";
		String sign = Md5Utils.MD5(openId+key+timestamp);
