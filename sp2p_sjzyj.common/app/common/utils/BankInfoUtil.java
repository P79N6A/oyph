...
public class BankInfoUtil {
    ...
    private final static String[] bankBin =
            {
            		"623052","623575","412962", "412963", "435744", "435745", "622525", "622526", "622538", "998800",
            		"428911", "436768", "436769", "436770", "491032", "491033", "491034", "491035", "491036", "491037", "491038", "436771",
            		"518364", "541709", "541710", "548844", "493427", "520152", "520382", "552794", "528931", "685800", "558894", "406365",
            		"487013", "406366", "6858000", "6858001", "6858009", "625072", "625809", "625071", "625808", "622568", "622558", "622555",
            		"622556", "622557", "622559", "622560", "621462", "625810", "628260", "628259", "625807", "625806", "625805",
            		"622388", "623063", "620043", "621267","623668",
    ...
    public static final String[] bankName = {
    		"农业银行","中国银行·薪享卡",
    		"深发银行·发展借记卡", "深发银行·发展借记卡", "深发银行·沃尔玛百分卡", "深发银行·沃尔玛百分卡", "深发银行·人民币信用卡金卡", "深发银行.人民币信用卡普卡", "深发银行·发展卡", "深发银行·发展卡",
            "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行.标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡",
            "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行.标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡", "广发银行·标准信用卡",
            "广发银行·标准信用卡",
            "广发银行·万事达信用卡", "广发银行·万事达信用卡", "广发银行·万事达信用卡", "广发银行·万事达信用卡", "广发银行·万事达信用卡", "广发银行·万事达信用卡",
            "广发银行·VISA信用卡", "广发银行·VISA信用卡", "广发银行·VISA信用卡", "广发银行·理财通", "广发银行·理财通", "广发银行·理财通", "广发银行·银联标准金卡", "广发银行·银联标准金卡",
            "广发银行·银联标准普卡","广发银行·银联标准普卡",
            "广发银行·理财通卡", "广发银行·银联标准白金卡", "广发银行·银联标准金卡", "广发银行·银联标准普卡", "广发银行·银联标准真情金卡", "广发银行·银联标准真情普卡", "广发银行·真情白金卡",
            "广发银行·真情白金卡", "广发银行·银联标准白金卡", "广发银行·银联公务金卡", "广发银行·银联公务普卡", "广发银行·银联真情白金卡", "广发银行·银联真情金卡", "广发银行·银联真情金卡",
            "福建海峡银行.榕城卡(银联卡)", "福建海峡银行·海福卡(IC卡)", "福建海峡银行·福州市民卡", "福建海峡银行·福州市民卡",
    		"建设银行·结算通卡",
            "邮政银行·绿卡通",
            "邮政银行·绿卡银联标准卡",
            "邮政银行·绿卡银联标准卡",
            ...
            "邮政银行·中国旅游卡（普卡）",
            "邮政银行·福农卡",
            "工商银行·牡丹运通卡金卡", "工商银行·牡丹运通卡金卡", "工商银行·牡丹运通卡金卡", "工商银行·牡丹VISA卡(单位卡)",
            ...
            "工商银行·牡丹灵通卡",
            "工商银行·海航信用卡个人普卡",
            "工商银行·牡丹灵通卡", "工商银行·牡丹灵通卡", "工商银行·牡丹灵通卡", "工商银行·牡丹灵通卡", "工商银行·牡丹灵通卡",
            ...
            "工商银行伦敦子行·借记卡", "工商银行伦敦子行·工银伦敦借记卡", "工商银行伦敦子行·借记卡",
            ...
            "农业银行贷记卡·中国旅游卡", "农业银行贷记卡·银联IC公务卡",
            "宁波市农业银行·市民卡B卡",
            "中国银行·联名卡", "中国银行·个人普卡", "中国银行·个人金卡", "中国银行·员工普卡",
            ...
            "中国银行曼谷分行·长城信用卡环球通", "中国银行曼谷分行·借记卡",
            "建设银行·龙卡准贷记卡", "建设银行·龙卡准贷记卡金卡", "建设银行·中职学生资助卡", "建设银行·乐当家银卡VISA", "建设银行·乐当家金卡VISA",
            ...
            "建设银行·中国旅游卡", "建设银行·龙卡IC公务卡", "建设银行·龙卡IC公务卡",
            "交通银行·交行预付卡", "交通银行·世博预付IC卡", "交通银行·太平洋互连卡", "交通银行·太平洋万事顺卡",
            ...
            "交通银行香港分行·双币种信用卡", "交通银行香港分行·双币种信用卡", "交通银行香港分行·双币卡", "交通银行香港分行·银联人民币卡", "交通银行澳门分行·银联借记卡",
            "中信银行·中信借记卡", "中信银行·中信借记卡",
            ...
            "光大银行·借记IC卡白金卡", "光大银行·借记IC卡金卡", "光大银行·阳光旅行卡", "光大银行·借记IC卡钻石卡", "光大银行·联名IC卡金卡", "光大银行·联名IC卡白金卡", "光大银行·联名IC卡钻石卡",
            "华夏银行·华夏卡(银联卡)",
            "华夏银行·华夏白金卡", "华夏银行·华夏普卡", "华夏银行·华夏金卡", "华夏银行·华夏白金卡", "华夏银行·华夏钻石卡", "华夏银行·华夏卡(银联卡)", "华夏银行·华夏至尊金卡(银联卡)", "华夏银行·华夏丽人卡(银联卡)",
            "华夏银行·华夏万通卡",
            "民生银行·民生借记卡(银联卡)", "民生银行·民生银联借记卡－金卡", "民生银行·钻石卡", "民生银行·民生借记卡(银联卡)", "民生银行·民生借记卡(银联卡)", "民生银行·民生借记卡(银联卡)",
            ...
            "招商银行·招商银行信用卡", "招商银行·招商银行信用卡", "招商银行·招商银行信用卡", "招商银行·招商银行信用卡", "招商银行·招商银行信用卡", "招商银行·两地一卡通",
            ...
            "兴业银行·兴业信用卡", "兴业银行·银联标准贷记普卡", "兴业银行·银联标准贷记普卡", "兴业银行·兴业芯片普卡", "兴业银行·兴业芯片金卡", "兴业银行·兴业芯片白金卡", "兴业银行·兴业芯片钻石卡",
            "浦发银行·浦发JCB金卡",
            "浦发银行·浦发JCB白金卡", "浦发银行·信用卡VISA普通", "浦发银行·信用卡VISA金卡", "浦发银行·浦发银行VISA年青卡", "浦发银行·VISA白金信用卡", "浦发银行·浦发万事达白金卡", "浦发银行·浦发JCB普卡",
            "浦发银行·浦发万事达金卡", "浦发银行·浦发万事达普卡", "浦发银行·浦发单币卡", "浦发银行·浦发银联单币麦兜普卡", "浦发银行·东方轻松理财卡", "浦发银行·东方-轻松理财卡普卡", "浦发银行·东方轻松理财卡",
            "浦发银行·东方轻松理财智业金卡", "浦发银行·东方卡(银联卡)", "浦发银行·东方卡(银联卡)", "浦发银行·东方卡(银联卡)", "浦发银行·公务卡金卡", "浦发银行·公务卡普卡", "浦发银行·东方卡",
            "浦发银行·东方卡", "浦发银行·浦发单币卡", "浦发银行·浦发联名信用卡", "浦发银行·浦发银联白金卡", "浦发银行·轻松理财普卡", "浦发银行·移动联名卡", "浦发银行·轻松理财消贷易卡",
            "浦发银行·轻松理财普卡（复合卡）", "浦发银行·贷记卡", "浦发银行·贷记卡", "浦发银行·东方借记卡（复合卡）", "浦发银行·电子现金卡（IC卡）", "浦发银行·移动浦发联名卡",
            "浦发银行·东方-标准准贷记卡", "浦发银行·轻松理财金卡（复合卡）", "浦发银行·轻松理财白金卡（复合卡）", "浦发银行·轻松理财钻石卡（复合卡）", "浦发银行·东方卡",
            "恒丰银行·九州IC卡",
            "恒丰银行·九州借记卡(银联卡)", "恒丰银行·九州借记卡(银联卡)",
            "天津市商业银行·银联卡(银联卡)",
            "烟台商业银行·金通卡",
            "潍坊银行·鸢都卡(银联卡)",
            "潍坊银行·鸳都卡(银联卡)",
            ...
            "上海银行·贷记IC卡", "上海银行·中国旅游卡（IC普卡）", "上海银行·中国旅游卡（IC金卡）", "上海银行·中国旅游卡（IC白金卡）", "上海银行·万事达钻石卡", "上海银行·淘宝IC普卡",
            "北京银行·京卡借记卡",
            "北京银行·京卡(银联卡)", "北京银行·京卡借记卡", "北京银行·京卡", "北京银行·京卡", "北京银行·借记IC卡", "北京银行·京卡贵宾金卡", "北京银行·京卡贵宾白金卡",
            "吉林银行·君子兰一卡通(银联卡)", "吉林银行·君子兰卡(银联卡)", "吉林银行·长白山金融IC卡", "吉林银行·信用卡", "吉林银行·信用卡", "吉林银行·公务卡",
            ...
            "平安银行·新磁条借记卡", "平安银行·平安银行IC借记卡", "平安银行·万事顺卡", "平安银行·平安银行借记卡", "平安银行·平安银行借记卡", "平安银行·万事顺借记卡",
            "焦作市商业银行·月季借记卡(银联卡)", "焦作市商业银行·月季城市通(银联卡)", "焦作市商业银行·中国旅游卡",
            "温州银行·金鹿卡",
            "汉口银行·九通卡(银联卡)", "汉口银行·九通卡", "汉口银行·借记卡", "汉口银行·借记卡",
            "盛京银行·玫瑰卡", "盛京银行·玫瑰IC卡", "盛京银行·玫瑰IC卡", "盛京银行·玫瑰卡", "盛京银行·玫瑰卡", "盛京银行·玫瑰卡(银联卡)", "盛京银行·玫瑰卡(银联卡)", "盛京银行·盛京银行公务卡",
            "洛阳银行·都市一卡通(银联卡)", "洛阳银行·都市一卡通(银联卡)", "洛阳银行·--",
            "大连银行·北方明珠卡", "大连银行·人民币借记卡", "大连银行·金融IC借记卡", "大连银行·大连市社会保障卡", "大连银行·借记IC卡", "大连银行·借记IC卡",
            "大连银行·大连市商业银行贷记卡", "大连银行·大连市商业银行贷记卡", "大连银行·银联标准公务卡",
            "苏州市商业银行·姑苏卡",
            "杭州商业银行·西湖卡", "杭州商业银行·西湖卡", "杭州商业银行·借记IC卡", "杭州商业银行·",
            "南京银行·梅花信用卡公务卡", "南京银行·梅花信用卡商务卡", "南京银行·梅花贷记卡(银联卡)", "南京银行·梅花借记卡(银联卡)", "南京银行·白金卡", "南京银行·商务卡",
            "东莞市商业银行·万顺通卡(银联卡)", "东莞市商业银行·万顺通卡(银联卡)", "东莞市商业银行·万顺通借记卡", "东莞市商业银行·社会保障卡",
            ...
            "成都商业银行·锦程卡金卡", "成都商业银行·锦程卡定活一卡通金卡", "成都商业银行·锦程卡定活一卡通", "成都商业银行·锦程力诚联名卡", "成都商业银行·锦程力诚联名卡", "成都商业银行·锦程卡(银联卡)",
            "抚顺银行·借记IC卡",
            ...
            "广州农村商业银行·福农太阳卡", "广东南海农村商业银行·盛通卡", "广东南海农村商业银行·盛通卡(银联卡)", "佛山顺德农村商业银行·恒通卡(银联卡)", "佛山顺德农村商业银行·恒通卡", "佛山顺德农村商业银行·恒通卡(银联卡)",
            "江阴农村商业银行·暨阳公务卡", "江阴市农村商业银行·合作贷记卡(银联卡)", "江阴农村商业银行·合作借记卡", "江阴农村商业银行·合作卡(银联卡)", "江阴农村商业银行·暨阳卡", "重庆农村商业银行·江渝借记卡VIP卡",
            "重庆农村商业银行·江渝IC借记卡", "重庆农村商业银行·江渝乡情福农卡", "东莞农村商业银行·信通卡(银联卡)", "东莞农村商业银行·信通卡(银联卡)", "东莞农村商业银行·信通信用卡", "东莞农村商业银行·信通借记卡",
            "东莞农村商业银行·贷记IC卡", "张家港农村商业银行·一卡通(银联卡)", "张家港农村商业银行·一卡通(银联卡)", "张家港农村商业银行·", "北京农村商业银行·信通卡", "北京农村商业银行·惠通卡",
            "北京农村商业银行·凤凰福农卡", "北京农村商业银行·惠通卡", "北京农村商业银行·中国旅行卡", "北京农村商业银行·凤凰卡", "天津农村商业银行·吉祥商联IC卡", "天津农村商业银行·信通借记卡(银联卡)", "天津农村商业银行·借记IC卡",
            "鄞州农村合作银行·蜜蜂借记卡(银联卡)", "宁波鄞州农村合作银行·蜜蜂电子钱包(IC)", "宁波鄞州农村合作银行·蜜蜂IC借记卡", "宁波鄞州农村合作银行·蜜蜂贷记IC卡", "宁波鄞州农村合作银行·蜜蜂贷记卡", "宁波鄞州农村合作银行·公务卡",
            "成都农村商业银行·福农卡", "成都农村商业银行·福农卡", "珠海农村商业银行·信通卡(银联卡)", "太仓农村商业银行·郑和卡(银联卡)", "太仓农村商业银行·郑和IC借记卡", "无锡农村商业银行·金阿福", "无锡农村商业银行·借记IC卡",
            "黄河农村商业银行·黄河卡", "黄河农村商业银行·黄河富农卡福农卡", "黄河农村商业银行·借记IC卡", "天津滨海农村商业银行·四海通卡", "天津滨海农村商业银行·四海通e芯卡", "武汉农村商业银行·汉卡", "武汉农村商业银行·汉卡",
            "武汉农村商业银行·中国旅游卡", "江南农村商业银行·阳湖卡(银联卡)", "江南农村商业银行·天天红火卡", "江南农村商业银行·借记IC卡", "海口联合农村商业银行·海口联合农村商业银行合卡", "湖北嘉鱼吴江村镇银行·垂虹卡",
            "福建建瓯石狮村镇银行·玉竹卡", "浙江平湖工银村镇银行·金平卡", "重庆璧山工银村镇银行·翡翠卡", "重庆农村商业银行·银联标准贷记卡", "重庆农村商业银行·公务卡", "南阳村镇银行·玉都卡", "晋中市榆次融信村镇银行·魏榆卡",
            "三水珠江村镇银行·珠江太阳卡", "东营莱商村镇银行·绿洲卡", "建设银行·单位结算卡", "玉溪市商业银行·红塔卡"
    };
...
//    }
    ...
    public static String getNameOfBank(String idCard) {
     ...
     /*   if (idCard == null || idCard.length() < 16 || idCard.length() > 19) {
        ...
        // 6位bin号
        String card_bin_6 = idCard.substring(0, 6);
        for (int i = 0; i < bankBin.length; i++) {
            if (card_bin_6.equals(bankBin[i]))
                index = i;
        }
        ...
        // 8位bin号
        String card_bin_8 = idCard.substring(0, 8);
        for (int i = 0; i < bankBin.length; i++) {
            if (card_bin_8.equals(bankBin[i]))
                index = i;
        }
    ...
    //传入银行卡名称 得到银行名称和简写
    public static String[] getBankSimpleName(String cardType) {
        if (cardType.contains("工商银行")) {
            return new String[]{"工商银行", "ICBC"};
        }
        if (cardType.contains("农业银行")) {
            return new String[]{"农业银行", "ABC"};
        }
        if (cardType.contains("交通银行")) {
            return new String[]{"交通银行", "BCM"};
        }
        if (cardType.contains("中国银行")) {
            return new String[]{"中国银行", "BOC"};
        }
        if (cardType.contains("建设银行")) {
            return new String[]{"建设银行", "CCB"};
        }
        if (cardType.contains("光大银行")) {
            return new String[]{"光大银行", "CEB"};
        }
        if (cardType.contains("中信银行")) {
            return new String[]{"中信银行", "CITIC"};
        }
        if (cardType.contains("兴业银行")) {
            return new String[]{"兴业银行", "CIB"};
        }
        if (cardType.contains("民生银行")) {
            return new String[]{"民生银行", "CMBC"};
        }
        if (cardType.contains("邮政银行")) {
            return new String[]{"邮政银行", "PSBC"};
        }
        if (cardType.contains("广发银行")) {
            return new String[]{"广发银行", "GDB"};
        }
        if (cardType.contains("浦发银行")) {
            return new String[]{"浦发银行", "SPDB"};
        }
        if (cardType.contains("北京银行")) {
            return new String[]{"北京银行", "BOB"};
        }
        if (cardType.contains("平安银行")) {
            return new String[]{"平安银行", "PINGAN"};
        }
        if (cardType.contains("渤海银行")) {
            return new String[]{"渤海银行", "CBHB"};
        }
        if (cardType.contains("上海银行")) {
            return new String[]{"上海银行", "BOS"};
        }
        if (cardType.contains("宜宾市商业银行")) {
            return new String[]{"宜宾市商业银行", "YBCCB"};
        }

        if (cardType.contains("浙商银行")) {
            return new String[]{"浙商银行", "CZB"};
        }

        if (cardType.contains("上海农商")) {
            return new String[]{"上海农商", "SRDB"};
        }
        if (cardType.contains("南京银行")) {
            return new String[]{"南京银行", "NJCB"};
        }
        return null;
    }
    
    //输入银行卡简写，得到银行卡简写和银行卡名称
    public static String[] getBankName(String bankCode) {
        if (bankCode.contains("ICBC")) {
            return new String[]{"工商银行", "ICBC"};
        }
        if (bankCode.contains("ABC")) {
            return new String[]{"农业银行", "ABC"};
        }
        if (bankCode.contains("COMM")) {
            return new String[]{"交通银行", "COMM"};
        }
        if (bankCode.contains("BOC")) {
            return new String[]{"中国银行", "BOC"};
        }
        if (bankCode.contains("CCB")) {
            return new String[]{"建设银行", "CCB"};
        }
        if (bankCode.contains("CEB")) {
            return new String[]{"光大银行", "CEB"};
        }
        if (bankCode.contains("CITIC")) {
            return new String[]{"中信银行", "CITIC"};
        }
        if (bankCode.contains("CIB")) {
            return new String[]{"兴业银行", "CIB"};
        }
        if (bankCode.contains("CMBC")) {
            return new String[]{"民生银行", "CMBC"};
        }
        if (bankCode.contains("PSBC")) {
            return new String[]{"邮政银行", "PSBC"};
        }
        if (bankCode.contains("GDB")) {
            return new String[]{"广发银行", "GDB"};
        }
        if (bankCode.contains("SPDB")) {
            return new String[]{"浦发银行", "SPDB"};
        }
        if (bankCode.contains("BJBANK")) {
            return new String[]{"北京银行", "BJBANK"};
        }
        if (bankCode.contains("SPABANK")) {
            return new String[]{"平安银行", "SPABANK"};
        }
        if (bankCode.contains("BOHAIB")) {
            return new String[]{"渤海银行", "BOHAIB"};
        }
        if (bankCode.contains("SHBANK")) {
            return new String[]{"上海银行", "SHBANK"};
        }
        if (bankCode.contains("YBCCB")) {
            return new String[]{"宜宾市商业银行", "YBCCB"};
        }

        if (bankCode.contains("CZBANK")) {
            return new String[]{"浙商银行", "CZBANK"};
        }

        if (bankCode.contains("SHRCB")) {
            return new String[]{"上海农商", "SHRCB"};
        }
        if (bankCode.contains("NJCB")) {
            return new String[]{"南京银行", "NJCB"};
        }
        return null;
    }
