...
public class TimeUtil {
	 ...
	 * @return
	 */
	public static String dateToStr_HHmmss(Date date) {
		if (date == null)
			return null;
		String str = null;
	 ...
	 * @return
	 */
	public static Date strToDate_yyyyMM(String str) {
		if (StringUtils.isBlank(str))
			return null;
		DateFormat format = new SimpleDateFormat("yyyy年MM月dd日");
		Date date = null;
		try {
			...
			Logger.error(e, "yyyy年MM月dd日转Date出现异常");
			return null;
		}
		return date;
	}
	...
	public static Date strToDateyyyyMMdd(String str) {
		...
		try {
			...
			Logger.error(e, "yyyy-MM-dd转Date出现异常");
			return null;
		}
		return date;
	}
