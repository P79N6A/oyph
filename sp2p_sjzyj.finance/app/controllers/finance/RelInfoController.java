...
public class RelInfoController extends BaseController {

	private static RelInfoService relInfoService = Factory.getService(RelInfoService.class);
	...
	public static void createXmlbByRelInfo() {
		try {
			...
			List<t_rel_info> t_rel_info = relInfoService.findAll();
			...
			// 6、生成xml文件
			File file = new File("data/day/FP.FP02.001.xml");
