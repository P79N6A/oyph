 ...
 *
 */
public class PublishMessageCtrl extends Controller{
    ...
    public static void policyRegulationsAppPre() {
 		render();
 	}
    ...
    /**储蓄管理条例*/
    public static void savingsManagementAppPre() {
 		render();
 	}
    /** 中华人民共和国商业银行法(2015年修正)*/
    public static void commercialBankLawAppPre() {
 		render();
 	}
    /**中华人民共和国中国人民银行法(2003修正)*/
    public static void peoplesBankLawAppPre() {
 		render();
 	}
    /**中华人民共和国人民币管理条例*/
    public static void rmbManagementAppPre() {
 		render();
 	}
    /**中华人民共和国银行业监督管理法(2006修正)*/
    public static void supervisionManagementAppPre() {
 		render();
 	}
    public static void constitutionAppPre() {
		render();
	}
	public static void financeAppPre() {
		render();
	}
	public static void debitAppPre() {
		render();
	}
	public static void lendingGuidelinesAppPre() {
		render();
	}
	public static void interimProceduresAppPre() {
		render();
	}
	public static void recordsAppPre() {
		render();
	}
}
