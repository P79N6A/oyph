...
public class MallConstants {
	...
	/** 商品排序 */
	public static final String[] MALL_GOODS_ORDER = {"order by id desc", "order by total", "order by surplus", "order by exchange_scroe",
			"order by time"};
	...
	public static final String STR_EXCHANGE = "兑换";// 兑换

	public static final String STR_SHARK = "摇一摇中奖";// 兑换
	
	public static final int REGISTER_REALNAME = 6;//注册并实名
